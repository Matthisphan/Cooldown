...
if($isAuth){
    $temps_restant = $json['temps_restant'];
    $stmt2 = $db->prepare("UPDATE users SET temps_restant = :temps_restant WHERE id_users = :userId");
    $stmt2->bindValue(':temps_restant', $temps_restant);
